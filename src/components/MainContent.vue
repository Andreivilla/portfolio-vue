<template>
  <main id="main-content" class="p-4 min-h-screen md:min-h-0 text-white
    bg-gradient-to-br from-[#1A0033] via-[#330066] to-[#4D0099] md:flex">
    <div class="flex flex-col items-center font-bold md:w-dvh">
      <h1 class="text-3xl text-primary">Desenvolvedor Full-Stack</h1>
...
<div class="mt-2 flex flex-col items-center">
  <div class="flex flex-wrap justify-center gap-4">
    <a href="https://www.linkedin.com/in/andrei-villa-7729801b6/" target="_blank"
      class="flex items-center gap-2 rounded-lg bg-primary py-3 px-4 
    ...
    <a href="https://wa.me/qr/CCL6LDE42Z4UC1" target="_blank"
      class="flex items-center gap-2 rounded-lg bg-primary py-3 px-4 
            font-sans text-xs font-bold uppercase text-white shadow-md 
            transition-all hover:shadow-lg hover:shadow-primary/20 
            focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] 
    ...
    >
      ...
      WhatsApp    
        ...
        <a 
          ...
          target="_blank"
          class="mt-4 rounded-lg bg-primary py-3 px-6 
                font-sans text-xs font-bold uppercase text-white shadow-md 
